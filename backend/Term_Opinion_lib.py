...
def run_extract_opinions(clauses: List[Dict[str, Any]], chat_func: Callable, max_new_tokens: int = 100) -> List[Dict[str, Any]]:
    """
    Trích xuất Opinion, sử dụng hàm chat_func được truyền vào.
    Tối ưu hóa RAM: xóa dữ liệu tạm thời sau mỗi clause.
    """
    final_clauses = []
...
Answer:"""
        ...
        # Giải phóng RAM sau mỗi clause
        del prompt, messages, opinion_text, opinions, valid_opinions
        gc.collect()
